 ...
 *
 * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/group/">Group</a>
 */
@AutoValue @AutoGson //
public abstract class GroupMessage implements Message {
   ...
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/group/#group-id">Group ID</a>
   */
  ...
  public static class Builder extends MessageBuilder<GroupMessage, Builder> {
     ...
     *
     * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/group/#traits">Traits</a>
     */
