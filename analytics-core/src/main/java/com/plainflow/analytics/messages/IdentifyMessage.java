 ...
 *
 * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/identify/">Identify</a>
 */
@AutoValue @AutoGson //
public abstract class IdentifyMessage implements Message {
  ...
  public static class Builder extends MessageBuilder<IdentifyMessage, Builder> {
     ...
     *
     * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/identify/#traits">Traits</a>
     */
