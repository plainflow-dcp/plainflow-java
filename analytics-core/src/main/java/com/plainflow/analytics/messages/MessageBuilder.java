package com.plainflow.analytics.messages;
...
public abstract class MessageBuilder<T extends Message, V extends MessageBuilder> {
   ...
   * may be dropped.
   *
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/common/">Common Fields</a>
   */
   ...
   *
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/common/#-timestamp-">Timestamp</a>
   */
   ...
   *
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/common/#context">Context</a>
   */
   ...
   *
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/identify/#identities">Identities</a>
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/identify/#anonymous-id">Anonymous ID</a>
   */
   ...
   *
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/identify/#identities">Identities</a>
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/identify/#user-id">User ID</a>
   */
   ...
   *
   * @see <a href="https://www.plainflow.com/docs/developers/data-tracking/common/#integrations">Integrations</a>
   */
